...
# ✅ 仅处理前 2420 个 query
batch_queries = df_queries.iloc[2421:4420]
output_file = "submission_bge_m2kr_part2_4420.csv"
...
with torch.no_grad():
    ...
    for idx, query in batch_queries.iterrows():
        ...
        print(f"[INFO] 处理 question_id: {question_id} ({idx}/4420)")
...
print(f"✅ 处理完成，查询 2421 到 4420 结果已保存到 {output_file}")
