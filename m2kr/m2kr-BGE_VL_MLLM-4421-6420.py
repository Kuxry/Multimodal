...
# ✅ 仅处理前 2420 个 query
batch_queries = df_queries.iloc[4421:6420]
output_file = "submission_bge_m2kr_part3_6420.csv"
...
with torch.no_grad():
    ...
    for idx, query in batch_queries.iterrows():
        ...
        print(f"[INFO] 处理 question_id: {question_id} ({idx}/6420)")
...
print(f"✅ 处理完成，查询 4420 到 6420 结果已保存到 {output_file}")
